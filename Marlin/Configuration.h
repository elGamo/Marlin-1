...
#define STRING_CONFIG_H_AUTHOR "(elGamo2, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 ProLB"
 ...
 *     O-- FRONT --+
 */
//ORG: #define NOZZLE_TO_PROBE_OFFSET { 10, 10, 0 }
#define NOZZLE_TO_PROBE_OFFSET { -44, -5, -3.50 }
